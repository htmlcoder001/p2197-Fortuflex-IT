...
function openDoor(e) {
  ...
  doorSales.forEach(function (sale) {
    if (door1.classList.contains("open")) {
      ...
      doorSale2.innerHTML = discount === "20%" ? "30%" : "20%";
      doorSale3.innerHTML = discount === "10%" ? "25%" : "30%";
    } else if (door2.classList.contains("open")) {
      doorSale2.innerHTML = discount;
      doorSale1.innerHTML = discount === "10%" ? "20%" : "30%";
      doorSale3.innerHTML = discount === "10%" ? "30%" : "10%";
    } else if (door3.classList.contains("open")) {
      doorSale1.innerHTML = discount === "10%" ? "30%" : "10%";
      doorSale3.innerHTML = discount;
      doorSale2.innerHTML = discount === "10%" ? "25%" : "30%";
    }
  });
